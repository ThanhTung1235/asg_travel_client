...
public class Comment  implements java.io.Serializable {
     ...
     * @return member
     */
    public comment.Member getMember() {
        return member;
    }
     ...
     * @param member
     */
    public void setMember(comment.Member member) {
        this.member = member;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://comment.service/", "member"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
