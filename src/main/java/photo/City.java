...
public class City  implements java.io.Serializable {
    private photo.District[] districts;

    private long mtp;

    private java.lang.String name;

    private photo.Place[] places;
     ...
     * @return districts
     */
    public photo.District[] getDistricts() {
        return districts;
    }
     ...
     * @param districts
     */
    public void setDistricts(photo.District[] districts) {
        this.districts = districts;
    }

    public photo.District getDistricts(int i) {
        return this.districts[i];
    }

    public void setDistricts(int i, photo.District _value) {
     ...
     * @param places
     */
    public void setPlaces(photo.Place[] places) {
        this.places = places;
    }

    public photo.Place getPlaces(int i) {
        return this.places[i];
    }

    public void setPlaces(int i, photo.Place _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://photo.service/", "city"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("districts");
        elemField.setXmlName(new javax.xml.namespace.QName("", "districts"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://photo.service/", "district"));
